...
No intuito de ~~provocar~~ responder a questão, utilizei o método *Labour Market Areas* - LMAs - do [ISTAT](http://www.istat.it/en/archive/142790) para desenvolver uma regionalização sintética do Rio Grande do Sul, e comparar com as regiões tradicionalmente utilizadas - meso e microrregiões.  

O método consiste em criar regiões em que a maioria dos trabalhadores que _moram_ numa região, também _trabalham_ na mesma região, ou seja, simultaneamente maximiza os relacionamentos internos e minimiza os relacionamentos externos. Em outras palavras, uma região em que os trabalhadores compartilham um mesmo mercado de trabalho.  

O argumento por trás deste objetivo é que uma região 
